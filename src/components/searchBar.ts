  ...
  return `
    <div id="mainSearchBar" class="grid grid-rows-[auto_auto] h-auto">
      <div class="mb-2 ml-15 mr-10 flex justify-center row-start-1 col-start-1">
        <img src="/Neko Search.png" alt="neko-search" class="w-full h-auto object-none">
      </div>
      <img src="/Cat.png" alt="neko-search" class="mr-10 w-auto h-auto row-start-1 col-start-2">
